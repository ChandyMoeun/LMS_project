<x-app-layout>
    <main class="mt-10 p-5">
        <div class="d-flex border-b-2 border-gray-300 px-8 h-15 items-center">
            ...
            <h1 class="font-bold text-3xl mt-3 hover:text-yellow-400 w-2/12"><b>Edit Types</b></h1>
        </div>
            ...
            <div class="bg-white shadow-md rounded-lg p-6">
                ...
                <form action="{{ route('admin.leavetype.update', $leaveTypes->id) }}" method="POST">
                    ...
                    <div class="flex justify-center space-x-4 mt-4">
                        <!-- Submit Button -->
                        <button type="submit" class="bg-yellow-400 text-white font-bold px-5 py-2 rounded-lg hover:bg-black transition-colors focus:outline-none focus:ring-2 focus:ring ">
                            Update
                        </button>
                    </div>
