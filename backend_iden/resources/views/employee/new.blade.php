<x-app-layout>
  <div class="mt-10">
    <div class="container p-10">
      <div class="d-flex border-b-2 border-gray-300 h-20 items-center mb-10">
        ...
        <h1 class="font-bold text-3xl w-3/12 mt-5 hover:text-yellow-400"><b>Add Employee </b></h1>
      </div>
        ...
        <form id="profileForm" method="POST" action="{{ route('admin.employee.store') }}" enctype="multipart/form-data">
          ...
          <div style="display: flex; justify-content:center; justify-content: space-between; width:100%;">
            ...
            <div style="width:48%;">
              ...
              <!-- Joined Date -->
              <div class="flex flex-col space-y-2">
                <label for="entitled_date" class="text-gray-600 select-none font-medium ml-3">Confirm Date</label>
