...
class NotificationController extends Controller
{
    ...
    public function index(): JsonResponse
    {
        ...
        // Pass the notifications count to the view (layout)
    ...
    // Inside LeaveController.php

    public function resetNotifications()
    {
        // Delete all notifications from the notifications table
    Notification::truncate(); // This will delete all notifications

    // Get the updated notification count (which should be 0 now)
