          ...
          <div class="mt-10 pb-20 px-10">
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
              <div class="flex justify-between px-4 py-3 sm:px-6">
                ...
                <!-- Search Bar -->
                <input v-model="searchQuery" placeholder="Search..." class="w-2/6 py-2 px-2 bg-blue-100 mt-3 h-9 border rounded" />
              </div>
              <div id="attendance_records" class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    <tr v-for="record in filteredAttendances" :key="record.id" class="hover:bg-gray-100 transition duration-150 ease-in-out">
...
export default {
  ...
  setup() {
    ...
    const filteredAttendances = computed(() => {
      ...
      return attendanceStore.attendance.filter(record => {
        return (
