              ...
              <form @submit.prevent="submitForm" enctype="multipart/form-data" class="flex flex-row justify-between p-3 gap-5">
                <div class="w-6/12">
                  <div class="username">
                    ...
                    <input v-model="user_name" id="user_name" class="mt-1 block w-full rounded-md border-gray-300 py-2 shadow-sm" placeholder="Enter your name" />
                  </div>
                  <div class="mt-4">
                  ...
                  <div class="mt-4">
                    <label for="from_date" class="block text-sm font-medium text-black">From Date/Time</label>
                  ...
                  <div class="mt-4">
                    <label for="to_date" class="block text-sm font-medium text-black">To Date/Time</label>
