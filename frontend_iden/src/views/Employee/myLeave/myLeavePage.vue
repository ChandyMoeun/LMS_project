          ...
          <main class="bg-gray sticky top-0">
            <div class="mt-5 pb-20">
              ...
              <div class="flex justify-end items-end mt-16 mb-3">
                <a href="#" class=" mr-10 px-3 py-1 bg-gray-900 text-white font-semibold rounded-lg shadow-md hover:bg-yellow-400 transition-colors no-underline">My History</a>
              </div>
