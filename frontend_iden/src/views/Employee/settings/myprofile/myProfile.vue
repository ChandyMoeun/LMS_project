    ...
    <div class="employee flex h-screen items-start w-full">
      ...
      <div class="container-page w-[83%]">
        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto p-[50px] pt-[50px] pb-0 h-auto w-full bg-[#EEEDED] mb-[50px]">
          <div class="px-10">
            <div class="text-black mt-7" style="display: flex; flex-direction: column; border-bottom: solid 1px gray">
              ...
              <h1 class="font-bold text-3xl mb-3 mt-3 px-3 hover:text-yellow-500 w-2/12">My Profile</h1>
            </div>
            <div class="container mx-auto px-6 py-8">
              <div class="bg-white shadow-md rounded my-6 p-5">
                <form @submit.prevent="handleSubmit" enctype="multipart/form-data">
                    <div class="bg-white rounded-lg flex justify-center flex-col">
                  ...
                  <div class="mt-4">
                    <button class="py-2 px-2 rounded-lg border border-gray-300 bg-blue-700 text-white hover:bg-yellow-400">Submit</button>
                  </div>
                </form>
              </div>
            </div>
