            ...
            <div class="container mx-auto">
              ...
              <div class="flex justify-between items-end mb-3">
                <input
                  ...
                  class="w-2/6 h-9 px-2 border rounded-lg shadow-md"
                />
                <a
                ...
                <table class="w-full divide-y divide-gray-200">
                  <thead class="bg-black">
                    <tr>
                      ...
                      <th class="py-3 px-2 text-center text-xs text-white uppercase tracking-wider">Approved On</th>
