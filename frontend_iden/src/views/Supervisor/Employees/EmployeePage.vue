          ...
          <tbody>
            <tr v-for="employee in filteredEmployees" :key="employee.staff_id" class="bg-gray-100 border-b border-gray-200">
              ...
              <td class="text-center w-3/12">
                ...
                <button @click="editEmployee(employee.id)" class="ml-2 text-white px-2 py-1 border-solid border-0 border-indigo-600 rounded-lg bg-gray-900 hover:bg-yellow-500"><a href="#" class="no-underline text-white">Update</a></button>
