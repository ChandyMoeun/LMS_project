  ...
  <div class="mt-10">
      <div class="container flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
        <div class="d-flex text-black" style="display: flex; flex-direction: column; border-bottom: solid 1px gray;">
          ...
          <h1 class="font-bold text-gray-900 mr-20 w-3/12 text-3xl mt-4 hover:text-yellow-400"><b>Update Employee </b></h1>
        </div>
        <div class="bg-white shadow-md rounded my-6 mt-20 p-10">
          <form @submit.prevent="submitForm" enctype="multipart/form-data">
            ...
            <div class="flex justify-between w-full">
              <div class="w-1/2 pr-4">
                ...
                <div class="flex flex-col space-y-2">
                  ...
                  <input type="number" v-model="form.staff_id" placeholder="Enter Staff ID" class="px-4 py-2 rounded-lg border border-gray-300" />
                </div>
            ...
            <div class="flex justify-center text-center mt-16 gap-3 mb-16">
              ...
              <button @ckick="submitForm" type="submit" class="w-1/12 mt-5 bg-gray-900 border-none rounded-lg text-white font-bold py-2 px-4 hover:bg-yellow-500 transition-colors">Submit</button>
            </div>
          </form>
        </div>
      </div>
