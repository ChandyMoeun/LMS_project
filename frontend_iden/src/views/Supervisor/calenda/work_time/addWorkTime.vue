      ...
      <div class="container-page">
        ...
        <main class="bg-gray sticky top-0">
          <div class="addWorkTime mt-3">
            <div
              class="d-flex text-black border-b-2 border-gray-300 px-8"
              style="display: flex; flex-direction: column; border-bottom: solid 1px gray"
            >
              <router-link to="/Supervisor/calendar">
                <svg
                  class="w-6 h-6 mt-3 text-gray-800 hover:text-gray-500"
                  aria-hidden="true"
              ...
              <h1 class="font-bold text-3xl mt-3 hover:text-yellow-400 w-2/6">
                <b>Add Working Days</b>
              </h1>
            </div>
              ...
              <div class="bg-white shadow-md rounded-lg p-6">
                <form @submit.prevent="handleSubmit">
                  ...
                  <div class="flex justify-center space-x-4 mt-4">
                    <button
                      type="submit"
                      class="bg-yellow-500 font-bold px-5 py-2 rounded focus:outline-none shadow hover:bg-black transition-colors border-none"
                    >
                      <a href="/Supervisor/calendar" class="no-underline text-white">Add</a>
                    </button>
                  </div>
                </form>
              </div>
