    ...
    <div class="supervisor">
      ...
      <div class="container-page">
        ...
        <main class="bg-gray sticky top-0">
          <div class="p">
            <div
              class="text-black px-8 m-6 items-right"
              style="display: flex; flex-direction: column; border-bottom: solid 1px gray"
            >
              <router-link to="/Supervisor/calendar">
                <svg
                  class="w-6 h-6 mt-3 text-gray-800 dark:text-white hover:text-gray-500"
                  aria-hidden="true"
              ...
              <h1 class="font-bold border-b-2 text-3xl mt-3 hover:text-yellow-400 w-3/12">
                <b>Add Holidays</b>
              </h1>
            </div>
