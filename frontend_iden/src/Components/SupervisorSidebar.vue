<template>
  <div class="sidebar d-flex flex-column flex-shrink-0 p-3 bg-dark text-white"
    ...
    <!-- Logo -->
    <div class="logo flex flex-col items-center justify-center mt-4">
      <img src="../assets/image/logo1.png" alt="Logo" class="w-21 mb-3 h-21 rounded-full object-cover" style="border: 2px solid whitesmoke; border-radius: 50%;" />
    ...
    <div class="nav nav-pills flex-column mb-auto gap-2">
      <a :class="['flex no-underline items-center mt-4 py-2 px-6 pr-30 text-gray-500 hover:bg-opacity-25 hover:rounded-lg hover:rounded-lg hover:text-gray-100', activeLink === '/supervisor/dashboard' ? 'active' : '']"
        href="/supervisor/dashboard"  @click="setActiveLink('/supervisor/dashboard')">
      ...
      <a :class="['flex no-underline items-center mt-4 py-2 px-6 text-gray-500 hover:bg-opacity-25 hover:rounded-lg hover:text-gray-100', activeLink === '/supervisor/calendars' ? 'active' : '']"
        href="/supervisor/calendars" @click="setActiveLink('/supervisor/calendar')" >
        <svg class="w-6 h-6 text-white-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
          <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 10h16M8 14h8m-4-7V4M7 7V4m10 3V4M5 20h14a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1H5a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1Z"/>
        </svg>
        <span class="mx-3">Calendar</span>
      </a>
      <a :class="['flex no-underline items-center mt-4 py-2 px-6 text-gray-500 hover:bg-opacity-25 hover:rounded-lg hover:text-gray-100', activeLink === '/supervisor/takeleave' ? 'active' : '']"
        href="/supervisor/takeleave" @click="setActiveLink('/supervisor/takeleave')" >
        <svg class="w-6 h-6 text-white-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" >
      ...
      <a :class="['flex no-underline items-center mt-4 py-2 px-6 text-gray-500 hover:bg-opacity-25 hover:rounded-lg hover:text-gray-100', activeLink === '/supervisor/employee' ? 'active' : '']"
      ...
      <a :class="['flex no-underline items-center mt-4 py-2 px-6 text-gray-500 hover:bg-opacity-25 hover:rounded-lg hover:text-gray-100', activeLink === '/supervisor/attendance' ? 'active' : '']"
        ...
        <!--Setting sidebar-->
      <a :class="['flex no-underline items-center mt-4 py-2 px-6 text-gray-500 hover:bg-opacity-25 hover:rounded-lg hover:text-gray-100', activeLink === '/supervisor/settings' ? 'active' : '']"
