<template>
  <div
    class="sidebar d-flex flex-column flex-shrink-0 p-3 bg-dark text-white"
  ...
  >
    ...
    <div class="logo flex flex-col items-center justify-center mt-4">
      <img
        ...
        alt="Logo"
        class="w-21 mb-3 h-21 rounded-full object-cover"
        style="border: 2px solid whitesmoke; border-radius: 50%;"
      />
      <span class="text-white text-1xl mx-1 font-semibold"
        >iDEN CREATEIVE CO,LTD</span
      >
    </div>

    <div class="nav nav-pills flex-column mb-auto gap-2">
      <a
        :class="['flex no-underline items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100', activeLink === '/employee/dashbaord' ? 'active' : '']"
      ...
      <a
        :class="['flex no-underline items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100', activeLink === '/employee/calendar' ? 'active' : '']"
        href="/employee/calendar"
        @click="setActiveLink('/employee/calendar')"
      >
        <svg
      ...
      <a
        :class="['flex no-underline items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100', activeLink === '/employee/myleave' ? 'active' : '']"
        href="/employee/myleave"
        @click="setActiveLink('/employee/myleave')"
      >
        <svg
          class="w-6 h-6 text-white-800 dark:text-white"
          aria-hidden="true"
      ...
      <!-- Add similar links for other routes: Employee, Attendance, etc. -->
    </div>
  </div>
</template>
